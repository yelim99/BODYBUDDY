<template>
    <div class="joinHeader">
        ...
        <div class="category">
            <span class="categoryA">Sign in</span>
            <span class="categoryB">Home &nbsp; > &nbsp; Sign in</span>
        </div>
    </div>
    <div class="container">
        <h4>회원가입</h4>
        ...
        <div class="item">
            <div class="form-floating">
                ...
                <button id="userIdBtn" @click="openPopupUserId">
                    중복 확인
                </button>
            </div>
...
.joinHeader .category .categoryA {
    font-size: 2em;
}

.joinHeader .category .categoryB {
    font-size: 0.8em;
}
